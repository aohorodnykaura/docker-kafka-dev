...
RUN wget https://mirror.nodesdirect.com/apache/kafka/2.8.0/kafka_2.13-2.8.0.tgz && \
    ...
    sed -iserver.properties.back 's$advertised.listeners=PLAINTEXT://localhost:9092$advertised.listeners=PLAINTEXT://:9092$g' /opt/kafka/config/kraft/server.properties
